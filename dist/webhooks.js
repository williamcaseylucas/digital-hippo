...
var ReceiptEmail_1 = require("./app/components/emails/ReceiptEmail");
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                try {
                    event = stripe_1.default.webhooks.constructEvent(body, signature, process.env.STRIPE_WEBHOOK_SECRET || "");
                }
                catch (err) {
                    return [2 /*return*/, res
                            .status(400)
