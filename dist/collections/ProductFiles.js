...
var yourOwnAndPurchased = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var user, products, ownProductFileIdsPre, ownProductFileIds, orders, purchasedProductFileIds;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    ownProductFileIdsPre = products.map(function (prod) { return prod.product_files; });
                    console.log("before cat", ownProductFileIdsPre);
                    ownProductFileIds = ownProductFileIdsPre.flat();
